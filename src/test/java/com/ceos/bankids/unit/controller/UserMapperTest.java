...
//        );
//        CommonResponse<UserDTO> result = userMapper.patchUserType(user, userTypeRequest);
//
//        // then
...
//            userMapper.patchUserType(user, userTypeRequest);
//        });
//    }
//
//    @Test
...
//            userMapper.patchUserType(user, null);
//        });
//    }
//
//    @Test
...
//            jwtTokenServiceImpl
//        );
//        CommonResponse result = userMapper.patchUserType(user, userTypeRequest);
//
//        // then
//        user.setBirthday("19990521");
//        user.setIsFemale(false);
...
//            jwtTokenServiceImpl
//        );
//        CommonResponse result = userMapper.refreshUserToken(user);
//
//        // then
...
//        );
//
//        CommonResponse result = userMapper.getUserInfo(user);
//
//        // then
...
//        );
//
//        CommonResponse result = userMapper.patchUserLogout(user);
//
//        ArgumentCaptor<User> uCaptor = ArgumentCaptor.forClass(User.class);
//        Mockito.verify(mockUserRepository, Mockito.times(1)).save(uCaptor.capture());
...
//        );
//
//        CommonResponse result = userMapper.deleteUserAccount(user1, withdrawalRequest);
//
...
//        );
//
//        CommonResponse result = userMapper.patchExpoToken(user, expoRequest, response);
//
//        ArgumentCaptor<User> uCaptor = ArgumentCaptor.forClass(User.class);
//        Mockito.verify(mockUserRepository, Mockito.times(1)).save(uCaptor.capture());
//        Assertions.assertEquals(user.getExpoToken(), uCaptor.getValue().getExpoToken());
...
//        );
//
//        CommonResponse<OptInDTO> result = userMapper.patchNoticeOptIn(user);
//
...
//        );
//
//        CommonResponse<OptInDTO> result = userMapper.patchServiceOptIn(user);
//
...
//        );
//
//        CommonResponse<OptInDTO> result = userMapper.getOptIn(user);
//
//        // then
